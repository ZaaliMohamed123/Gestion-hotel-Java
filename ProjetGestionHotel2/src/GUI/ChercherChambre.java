...
public class ChercherChambre extends MyFrame implements ActionListener{
	...
	public ChercherChambre() {
		...
		MyTitlePanel tp = new MyTitlePanel("Chercher une Chambre");
		tp.setPreferredSize(new Dimension(300,100));
		
		JPanel p1 = new JPanel();
		p1.setLayout(new FlowLayout(FlowLayout.CENTER));
		ltf0 = new MyLabeledTextField("Entrez le numero de Chambre", 250,250);
		p1.add(ltf0);
